...
@IBDesignable open class RangeSeekSlider: UIControl {
    ...
    @IBInspectable open var minValue: CGFloat = 0.00 {
        didSet {
            refresh()
        }
    }
    ...
    @IBInspectable open var maxValue: CGFloat = 1.00 {
        didSet {
            refresh()
        }
    }
    ...
    @IBInspectable open var selectedMinValue: CGFloat = 0.00 {
        didSet {
    ...
    @IBInspectable open var selectedMaxValue: CGFloat = 1.00 {
        didSet {
...
//            minLabel.string = numberFormatter.string(from: selectedMinValue as NSNumber)
            minLabel.string = String(format:"%.2f",selectedMinValue)
        }
...
//            maxLabel.string = numberFormatter.string(from: selectedMaxValue as NSNumber)
            maxLabel.string = String(format:"%.2f",selectedMaxValue)
        }
